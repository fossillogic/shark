 ...
 * @param compress_level Compression level 1-9 (0 for default)
 * @param solid Create solid archive
 * @param split_size Split archive into chunks of specified size (0 for no split)
