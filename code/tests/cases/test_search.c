...
{
    FOSSIL_ADD_TEST(c_search_command_suite, c_test_search_null_path);
    ...
    FOSSIL_ADD_TEST(c_search_command_suite, c_test_search_regex_extension_match);
    FOSSIL_ADD_TEST(c_search_command_suite, c_test_search_regex_character_class);
    FOSSIL_ADD_TEST(c_search_command_suite, c_test_search_regex_alternation);
    FOSSIL_ADD_TEST(c_search_command_suite, c_test_search_regex_line_anchor_start);
    FOSSIL_ADD_TEST(c_search_command_suite, c_test_search_regex_line_anchor_end);
    FOSSIL_ADD_TEST(c_search_command_suite, c_test_search_regex_wildcard);
    FOSSIL_ADD_TEST(c_search_command_suite, c_test_search_regex_optional_quantifier);
    FOSSIL_ADD_TEST(c_search_command_suite, c_test_search_regex_escape_literals);
    FOSSIL_ADD_TEST(c_search_command_suite, c_test_search_invalid_regex);
    FOSSIL_ADD_TEST(c_search_command_suite, c_test_search_binary_file_skip);
    FOSSIL_ADD_TEST(c_search_command_suite, c_test_search_plain_string_bug);

    FOSSIL_ADD_SUITE(c_search_command_suite);
}
