...
{
    // Test with null text
    int result = fossil_spino_cryptic(cnull, true, false, "caesar");
...
FOSSIL_TEST(c_test_cryptic_null_cipher)
{
    ...
    int result = fossil_spino_cryptic("hello", true, false, cnull);
    ASSUME_NOT_EQUAL_I32(result, 0);
}
...
FOSSIL_TEST(c_test_cryptic_no_operations)
{
    ...
    int result = fossil_spino_cryptic("hello", false, false, "caesar");
    ASSUME_NOT_EQUAL_I32(result, 0);
}
...
FOSSIL_TEST(c_test_cryptic_caesar_encode)
{
    ...
    int result = fossil_spino_cryptic("hello", true, false, "caesar");
...
{
    // Test ROT13 encoding
    int result = fossil_spino_cryptic("hello", true, false, "rot13");
    ASSUME_ITS_EQUAL_I32(result, 0);
}
...
FOSSIL_TEST(c_test_cryptic_base64_encode)
{
    ...
    int result = fossil_spino_cryptic("hello", true, false, "base64");
    ASSUME_ITS_EQUAL_I32(result, 0);
}
...
FOSSIL_TEST(c_test_cryptic_base32_encode)
{
    ...
    int result = fossil_spino_cryptic("hello", true, false, "base32");
    ASSUME_ITS_EQUAL_I32(result, 0);
}
...
FOSSIL_TEST(c_test_cryptic_atbash_encode)
{
    ...
    int result = fossil_spino_cryptic("hello", true, false, "atbash");
    ASSUME_ITS_EQUAL_I32(result, 0);
}
...
FOSSIL_TEST(c_test_cryptic_vigenere_with_key)
{
    ...
    int result = fossil_spino_cryptic("hello", true, false, "vigenere");
    ASSUME_ITS_EQUAL_I32(result, 0);
}
...
FOSSIL_TEST(c_test_cryptic_binary_encode)
{
    ...
    int result = fossil_spino_cryptic("hello", true, false, "binary");
    ASSUME_ITS_EQUAL_I32(result, 0);
}
...
FOSSIL_TEST(c_test_cryptic_morse_encode)
{
    ...
    int result = fossil_spino_cryptic("hello", true, false, "morse");
    ASSUME_ITS_EQUAL_I32(result, 0);
}
...
FOSSIL_TEST(c_test_cryptic_baconian_encode)
{
    ...
    int result = fossil_spino_cryptic("hello", true, false, "baconian");
    ASSUME_ITS_EQUAL_I32(result, 0);
}
...
FOSSIL_TEST(c_test_cryptic_railfence_encode)
{
    ...
    int result = fossil_spino_cryptic("hello", true, false, "railfence");
    ASSUME_ITS_EQUAL_I32(result, 0);
}
...
{
    // Test Haxor encoding
    int result = fossil_spino_cryptic("hello", true, false, "haxor");
    ASSUME_ITS_EQUAL_I32(result, 0);
}
...
FOSSIL_TEST(c_test_cryptic_leet_encode)
{
    ...
    int result = fossil_spino_cryptic("hello", true, false, "leet");
    ASSUME_ITS_EQUAL_I32(result, 0);
}
...
FOSSIL_TEST(c_test_cryptic_unsupported_cipher)
{
    ...
    int result = fossil_spino_cryptic("hello", true, false, "unknown_cipher");
    ASSUME_NOT_EQUAL_I32(result, 0);
}
...
FOSSIL_TEST(c_test_cryptic_empty_text)
{
    ...
    int result = fossil_spino_cryptic("", true, false, "caesar");
    ASSUME_NOT_EQUAL_I32(result, 0);
}
...
FOSSIL_TEST(c_test_cryptic_long_text)
{
    ...
    int result = fossil_spino_cryptic(long_text, true, false, "caesar");
    ASSUME_ITS_EQUAL_I32(result, 0);
}
...
FOSSIL_TEST(c_test_cryptic_unicode_text)
{
    ...
    int result = fossil_spino_cryptic("café", true, false, "base64");
    ASSUME_ITS_EQUAL_I32(result, 0);
}
...
FOSSIL_TEST(c_test_cryptic_base64_decode)
{
    ...
    int result = fossil_spino_cryptic("aGVsbG8=", false, true, "base64");
    ASSUME_ITS_EQUAL_I32(result, 0);
}
...
FOSSIL_TEST(c_test_cryptic_rot13_roundtrip)
{
    ...
    int result = fossil_spino_cryptic("uryyb", false, true, "rot13");
    ASSUME_ITS_EQUAL_I32(result, 0);
}
...
FOSSIL_TEST(c_test_cryptic_whitespace_text)
{
    ...
    int result = fossil_spino_cryptic("hello world\nfoo bar", true, false, "base64");
    ASSUME_ITS_EQUAL_I32(result, 0);
}
...
FOSSIL_TEST(c_test_cryptic_numeric_text)
{
    ...
    int result = fossil_spino_cryptic("1234567890", true, false, "caesar");
    ASSUME_ITS_EQUAL_I32(result, 0);
}
...
FOSSIL_TEST(c_test_cryptic_mixed_case)
{
    ...
    int result = fossil_spino_cryptic("HeLLo WoRLd", true, false, "rot13");
    ASSUME_ITS_EQUAL_I32(result, 0);
}
