...
{
    FOSSIL_SUITE_ADD(c_create_command_suite, c_test_create_null_parameters);
    FOSSIL_SUITE_ADD(c_create_command_suite, c_test_create_simple_file);
    FOSSIL_SUITE_ADD(c_create_command_suite, c_test_create_simple_directory);
    FOSSIL_SUITE_ADD(c_create_command_suite, c_test_create_invalid_type);
    FOSSIL_SUITE_ADD(c_create_command_suite, c_test_create_existing_file);
    FOSSIL_SUITE_ADD(c_create_command_suite, c_test_create_existing_directory);
    FOSSIL_SUITE_ADD(c_create_command_suite, c_test_create_with_parent_dirs);
    FOSSIL_SUITE_ADD(c_create_command_suite, c_test_create_without_parent_dirs);
    FOSSIL_SUITE_ADD(c_create_command_suite, c_test_create_nested_directory);
    FOSSIL_SUITE_ADD(c_create_command_suite, c_test_create_file_with_special_characters);
    FOSSIL_SUITE_ADD(c_create_command_suite, c_test_create_directory_with_special_characters);
    FOSSIL_SUITE_ADD(c_create_command_suite, c_test_create_deep_nested_structure);
    FOSSIL_SUITE_ADD(c_create_command_suite, c_test_create_empty_filename);
    FOSSIL_SUITE_ADD(c_create_command_suite, c_test_create_file_in_current_dir);
    FOSSIL_SUITE_ADD(c_create_command_suite, c_test_create_file_case_sensitivity);
    FOSSIL_SUITE_ADD(c_create_command_suite, c_test_create_type_case_sensitivity);
