...
{
    FOSSIL_SUITE_ADD(c_dedupe_command_suite, c_test_dedupe_null_parameters);
    FOSSIL_SUITE_ADD(c_dedupe_command_suite, c_test_dedupe_empty_directory);
    FOSSIL_SUITE_ADD(c_dedupe_command_suite, c_test_dedupe_no_duplicates);
    FOSSIL_SUITE_ADD(c_dedupe_command_suite, c_test_dedupe_detect_duplicates_by_hash);
    FOSSIL_SUITE_ADD(c_dedupe_command_suite, c_test_dedupe_detect_duplicates_by_size);
    FOSSIL_SUITE_ADD(c_dedupe_command_suite, c_test_dedupe_delete_duplicates);
    FOSSIL_SUITE_ADD(c_dedupe_command_suite, c_test_dedupe_link_duplicates);
    FOSSIL_SUITE_ADD(c_dedupe_command_suite, c_test_dedupe_json_output);
    FOSSIL_SUITE_ADD(c_dedupe_command_suite, c_test_dedupe_fson_output);
    FOSSIL_SUITE_ADD(c_dedupe_command_suite, c_test_dedupe_invalid_directory);
    FOSSIL_SUITE_ADD(c_dedupe_command_suite, c_test_dedupe_mixed_files_and_duplicates);
