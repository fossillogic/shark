...
FOSSIL_TEST_EXPORT(c_show_command_tests);
FOSSIL_TEST_EXPORT(c_introspect_command_tests);
...
int main(int argc, char **argv) {
    ...
    FOSSIL_TEST_IMPORT(c_show_command_tests);
    FOSSIL_TEST_IMPORT(c_introspect_command_tests);
